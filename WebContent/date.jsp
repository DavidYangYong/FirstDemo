...
<link id="bs-css"
	...
	rel="stylesheet">
<link id="bsdp-css"
	href="${pageContext.request.contextPath }/bootstrap-datepicker/css/bootstrap-datepicker3.css"
	rel="stylesheet">
<script>
...
<!--[if lt IE 9]>
    ...
    <![endif]-->
<script
	src="${pageContext.request.contextPath }/bootstrap-datepicker/js/prettify.min.js"></script>
<script
	src="${pageContext.request.contextPath }/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
<script
	src="${pageContext.request.contextPath }/bootstrap-datepicker/js/locales/bootstrap-datepicker.zh-CN.min.js"
